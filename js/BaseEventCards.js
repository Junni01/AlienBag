const BaseEventCards = [
    ...
    },
    {
        ...
        "QueenMove": true,
        "CardName": "Hunt",
        "RealCardText": "Move every Adult not in Combat to a neighboring Room with a Character, if possible. If there are several Rooms to choose from, move the Adult to the Room with the lowest Room Number.",
        "AppCardText": "Move every Adult not in Combat to a neighboring Room with a Character, if possible. If there are several Rooms to choose from, move the Adult to the Room with the lowest Room Number.",
        "RemoveAndReshuffleDeck": false,
        "ReshuffleBack": false,
        "AlienBagSpecialCase": false,
        "SpecialCaseID": 0
    ...
    },
    {
        ...
        "AppCardText": "Set the Item Counter to 0 in each Room with a Fire marker. Place a Fire marker in each Room neighboring a Room with a Fire marker. Fire does not spread through Closed Doors of Technical Corridors.",
        "RemoveAndReshuffleDeck": false,
        "ReshuffleBack": false,
        "AlienBagSpecialCase": false,
        "SpecialCaseID": 0
    },
    {
        ...
        "RealCardText": "Place a Malfunction marker in the explored Room with the lowest Room Number. Then, shuffle this card back into the events deck.",
        "AppCardText": "Place a Malfunction marker in the explored Room with the lowest Room Number.",
        "RemoveAndReshuffleDeck": false,
        "ReshuffleBack": true,
        "AlienBagSpecialCase": false,
        "SpecialCaseID": 0
    },
    {
        ...
        "AppCardText": "Remove all Intruders which are not in a Room with any Character from the board. Add their respective tokens into the Intruder bag (manually).",
        "RemoveAndReshuffleDeck": false,
        "ReshuffleBack": false,
    ...
    },
    {
        ...
        "RealCardText": "Launch the Escape Pod token with the lowest number. Remove this Event from the game and reshuffle the Events deck (including the Discard pile).",
        "AppCardText": "Launch the Escape Pod token with the lowest number.",
        "RemoveAndReshuffleDeck": true,
        "ReshuffleBack": false,
        "AlienBagSpecialCase": false,
        "SpecialCaseID": 0
    ...
    },
    {
        ...
        "RealCardText": "Place a Malfunction marker in each explored Green Room. Remove this Event from the game and reshuffle the Events deck (including the Discard pile).",
        "AppCardText": "Place a Malfunction marker in each explored Green Room.",
        "RemoveAndReshuffleDeck": true,
        "ReshuffleBack": false,
        "AlienBagSpecialCase": false,
        "SpecialCaseID": 0
