const voidSeederEventCards = [
    ...
    },
    {
        ...
        "RealCardText": "Remove the Escape pod token with the highest number. Remove this card from the game and reshuffle the Event deck (including the Discard Pile.)",
        "AppCardText": "Remove the Escape pod token with the highest number.",
        "RemoveAndReshuffleDeck": true,
        "ReshuffleBack": false,
        "AlienBagSpecialCase": false,
        "SpecialCaseID": 0
